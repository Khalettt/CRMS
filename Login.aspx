...
<head>
  ...
  <title>Car Rental Managment System | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>Car Managment System</b></a>
  </div>
  <!-- /.login-logo -->
  ...
  <asp:TextBox ID="txtUsername" class="form-control" placeholder="Username..." runat="server"></asp:TextBox>
    ...
    <asp:TextBox ID="txtPassword" class="form-control" placeholder="Password" TextMode="Password" runat="server"></asp:TextBox>
      ...
      <asp:Button ID="btnLogin" runat="server" class="btn btn-block btn-primary" Text="Login" OnClick="btnLogin_Click" />
      </div>
      </form>
